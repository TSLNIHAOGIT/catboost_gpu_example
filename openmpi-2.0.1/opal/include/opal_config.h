...
#define MCA_io_romio314_COMPLETE_CONFIGURE_FLAGS " FROM_OMPI=yes CC='gcc' CFLAGS='-O3 -DNDEBUG -finline-functions -fno-strict-aliasing -pthread -D__EXTENSIONS__' CPPFLAGS='  -I/jupyter/tsl/openmpi-2.0.1/opal/mca/hwloc/hwloc1112/hwloc/include -I/jupyter/tsl/openmpi-2.0.1/opal/mca/event/libevent2022/libevent -I/jupyter/tsl/openmpi-2.0.1/opal/mca/event/libevent2022/libevent/include' FFLAGS='' LDFLAGS=' ' --enable-shared --disable-static  --prefix=/usr/local/openmpi --disable-aio --disable-weak-symbols --enable-strict"
...
#define OPAL_PACKAGE_STRING "Open MPI root@4bce6908eb17 Distribution"
...
#define WRAPPER_EXTRA_LIBS "-lm -lutil "
